...
class testEquationSolverClass(unittest.TestCase):
    ...
    def test_secondDegreeEquation_case_for_solutions(self):
        ...
        self.assertEqual(self.tst.second_degree_equation_solver(1, 2, 8), (None, None), msg="D<0 hiba")
        print("running test 2")
        self.assertEqual(self.tst.second_degree_equation_solver(1, -14, 49), (7, 7), msg="D=1 hiba")
        print("running test 3")
        self.assertEqual(self.tst.second_degree_equation_solver(1, 6, 8), (-2, -4), msg="D=2 hiba")

    #TypeError visszadobásának tesztelése
    def test_secondDegreeEquation_case_TypeError(self):
        print("running TypeError test")
        with self.assertRaises(TypeError):
            result = self.tst.second_degree_equation_solver(True, 2, 4)
